...
# Form implementation generated from reading ui file 'resolution_test.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "文件名（um）："))
        self.label_2.setText(_translate("MainWindow", "  图像格式："))
...
class PicShow(QMainWindow, Ui_MainWindow):
    ...
    def text_display(self, con):

        self.textBrowser.append(con)  # 在指定的区域显示提示信息
